...
// TableName 指定表名。
func (Agent) TableName() string { return "os_agents" }
...
// TableName 指定表名。
func (Skill) TableName() string { return "os_skills" }
...
// TableName 指定表名。
func (AgentSkill) TableName() string { return "os_agent_skills" }
...
// TableName 指定表名。
func (AgentSession) TableName() string { return "os_agent_sessions" }
...
// TableName 指定表名。
func (AgentStateLog) TableName() string { return "os_agent_state_log" }
...
// TableName 指定表名。
func (AgentSessionQueue) TableName() string { return "os_agent_session_queues" }
