...
// TableName 指定表名。
func (QueueSkill) TableName() string { return "oc_queue_skills" }

// TableName 指定表名。
func (Queue) TableName() string { return "oc_queues" }
...
// TableName 指定表名。
func (QueueAgent) TableName() string { return "oc_queue_agents" }
